...
#include"manager.h"
#include"camera.h"
ID3D11Buffer* TreeTexture::m_VertexBuffer;
ID3D11ShaderResourceView* TreeTexture::m_Texture;

void TreeTexture::Init()
{
...
void TreeTexture::Update()
{

}

void TreeTexture::Draw()
{
